...
const deleteSong = (id) => {
  ...
  if (userData?.songs.length === 0) {
    ...
    // Устанавливаем id и aria-label для кнопки resetButton
...
const setPlayerDisplay = () => {
  ...
  // Используем тернарный оператор для установки текста названия песни
  playingSong.textContent = currentTitle ? currentTitle : "";

  // Используем тернарный оператор для установки текста исполнителя песни
